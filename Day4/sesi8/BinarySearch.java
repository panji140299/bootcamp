public class BinarySearch {
    ...
    public static void main(String[] args) {
        ...
        int i = BinarySearch.pencarianBinary(myArray, key1);
        int j = BinarySearch.pencarianBinary(myArray, key2);
        int k = BinarySearch.pencarianBinary(myArray, key3);
        int l = BinarySearch.pencarianBinary(myArray, key4);
